...
/* Function to check read/write access to thread's own stack memory buffer */
static void thread_stack_rw_access(void *p1, void *p2, void *p3)
{
	set_fault_valid(false);
 ...
 * memory buffer
 *
 * @details User thread can access its own stack memory buffer and perform
 * read/write operations.
 *
 * @ingroup kernel_memprotect_tests
 */
void test_stack_user_rw_access(void)
{
	set_fault_valid(false);
...
/**
 * @brief Test kernel provides superuser thread read/write access to its own
 * stack memory buffer
 *
 * @details Superuser thread can access its own stack memory buffer and perform
 * read/write operations.
 *
 * @ingroup kernel_memprotect_tests
 */
void test_stack_superuser_rw_access(void)
{
	set_fault_valid(false);
